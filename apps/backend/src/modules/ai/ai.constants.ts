...
export const GENERATE_POST_SYSTEM_PROMPT =
  ...
  '   Deriva el hook del TEMA concreto: menciónalo con un dato, una situación o una pregunta específica de ese tema; ' +
  '   nunca un gancho genérico que sirva para cualquier negocio. ' +
...
export const GENERATE_CAMPAIGN_SYSTEM_PROMPT =
  ...
  'Diseñas la configuración inicial de una campaña automatizada para Facebook. ' +
...
export const GENERATE_REPLY_SYSTEM_PROMPT =
